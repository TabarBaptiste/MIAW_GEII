...
<head>
    ...
    <link href="view/assets/css/espace_entreprise.css" rel="stylesheet">
    ...
    <div class="container-fluid">
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <h3>Projets Tutorés</h3>
                        <a class="btn btn-primary mb-2" href="index.php?page=form_tuteures">Ajouter un projet tutoré</a>
                    </div>
                    <?php
